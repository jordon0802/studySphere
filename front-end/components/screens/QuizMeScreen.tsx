...
function QuizMeScreen() {
    ...
    const renderOption1 = (quiz: QuizData) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => handleAnswer(quiz.option1)}
                style={styles.quizOptionContainer}
            >
                <Text style={styles.quizOptionText}> {quiz.option1} </Text>
            </TouchableOpacity>
        );
    };
    ...
    const renderOption2 = (quiz: QuizData) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => handleAnswer(quiz.option2)}
                style={styles.quizOptionContainer}
            >
                <Text style={styles.quizOptionText}> {quiz.option2} </Text>
            </TouchableOpacity>
        );
    };
    ...
    const renderOption3 = (quiz: QuizData) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => handleAnswer(quiz.option3)}
                style={styles.quizOptionContainer}
            >
                <Text style={styles.quizOptionText}> {quiz.option3} </Text>
            </TouchableOpacity>
        );
    };
    ...
    const renderOption4 = (quiz: QuizData) => {
        ...
        return (
            <TouchableOpacity
                onPress={() => handleAnswer(quiz.option4)}
                style={styles.quizOptionContainer}
            >
                <Text style={styles.quizOptionText}> {quiz.option4} </Text>
            </TouchableOpacity>
        );
    };
                ...
                {quizzes.length <= 0 ? (
                    ...
                    <View>
                        <View style={styles.resultContainer}>
                            <Text style={styles.quizResultStyle}>
                                {" "}
                                Your Score is:{" "}
                            </Text>
                            <Text style={styles.quizResultStyle}>
                    ...
                    <View>
                        <View style={styles.quizQuestionContainer}>
                            <TouchableOpacity
                                onPress={() =>
                                    confirmDelete(quizzes[currentQuestion].id)
                                }
